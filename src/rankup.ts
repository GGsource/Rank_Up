class Row {
	...
	constructor(isNewRow = false) {
		...
		addRowAboveButton.src = "/images/addRowAboveIcon.png";
		...
		dragHandle.src = "/images/DragHandleIcon.png";
		...
		addRowBelowButton.src = "/images/addRowBelowIcon.png";
		...
		resetButton.style.backgroundImage = "url('/images/RowHeaderClear.png')"; // Set background image for delete button
		...
		deleteButton.style.backgroundImage = "url('/images/RowHeaderDelete.png')"; // Set background image for delete button
